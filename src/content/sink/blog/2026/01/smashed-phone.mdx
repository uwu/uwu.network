...
<I src="https://hy2.yellows.ink/d88d53d4b.png" />
...
λ ./libmagiskboot.so repack magisk_patched-30600_YTW9E.img give_adb_magisk_patched-30600_YTW9E.img
```
...
tokay:/ # ^D
tokay:/ $ ^D
λ adb pull /storage/emulated/0/busybox busybox-android
```
...
```sh
λ adb shell su -c dmesg | grep hazel
