...
:::alert{type="tip"}
All the components—scraping, fine-tuning, inference and discord bot can run locally, and the code itself is open-source and available here: [taskylizard/taskybot](https://github.com/taskylizard/taskybot)
...
![Image of Discord Export Data section in settings](/discord-data-export.png)
...
![taskybot shitposting](/taskybot-shitpost.png)
