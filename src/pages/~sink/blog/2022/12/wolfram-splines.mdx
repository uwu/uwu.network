...
which can be rearranged to <K>{`P_4=\\frac{2P_3}{P_2}`}</K>,
...
Simplify[
  ...
  D[cubicbezier[P3, P4, P5, P6, t - 1], {t, 2}],
  {
    t == 1,
    P2 + P4 == 2 P3
  }
...
The constraint is more usefully rearranged to: <K>P_5=P_1-4P_3+4P_4</K>.
...
Simplify[
  ...
  `P0 + 12 P4 + P6 == 8 P3 + 6 P5`
  ]}
/>

If we now consider our rules:
- <K>P_2 + P_4 = 2P_3</K>
- <K>P_1 + 4 P_4 = 4 P_3 + P_5</K>
- <K>P_0 + 12 P_4 + P_6 = 8 P_3 + 6 P_5</K>

And put all of the first curve's points on the right,
and the second curve's points on the left:

- <K>P_4=P_2-2P_3</K>
- <K>4P_4-P_5=4P_3-P_1</K>
- <K>12P_4+P_6-6P_5=8P_3-P_0</K>
...
<NotebookCell
  cells={[
    `
proofP4 = proofP2 - 2 proofP3
proofP5 = SolveValues[
  4 proofP4 - P5 == 4 proofP3 - proofP1,
  P5
  ][[1]]
proofP6 = SolveValues[
  12 proofP4 + P6 - 6 proofP5 == 8 proofP3 - proofP0,
  P6
  ][[1]]`,
  `proofP2 - 2 proofP3`,
  `proofP1 + 4 proofP2 - 12 proofP3`,
  `-proofP0 + 6 proofP1 + 12 proofP2 - 40 proofP3`
  ]}
/>

So the points of the second Beziér curve are fully constrained by the first curve:
- <K>P_4=P_2-2P_3</K>
- <K>P_5=P_1+4P_2-12P_3</K>
- <K>P_6=-P_0+6P_1+12P_2-40P_3</K>

// TODO help this is VERY VERY VERY wrong help must fix
