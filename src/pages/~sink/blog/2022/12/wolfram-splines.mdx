...
You could even make the plot fit the theming of uwu.network more,
by making it minimal and changing the colours:
...
ListLinePlot[
  ...
  PlotTheme -> Minimal
    ...
    ["IMG", "/sink/quiet_beziers/plotted_custom_bezier_minimal.svg"]
  ]}
/>
