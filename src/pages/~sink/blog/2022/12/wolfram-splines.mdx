...
<K>G^0</K> (tangent) continuity is tested for similar to <K>C^1</K>,
but normalising both vectors before testing them.

<K>G^1</K> continuity requires the *curvature* of the splines to be continuous
where they join.
...
<NotebookCell
  cells={[
    `
Simplify[
  D[D[cubicbezier[P0, P1, P2, P3, t], t], t] ==
  D[D[cubicbezier[P3, P4, P5, P6, t - 1], t], t],
  {
    t == 1,
    P2 + P4 == 2 P3
  }
...
The constraint is more usefully rearranged to: <K>{`P_5=\\frac{P_1+4P_4}{4P_3}`}</K>.
