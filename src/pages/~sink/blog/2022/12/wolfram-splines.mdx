...
Hold on a second... Those don't match, the <K>t^3</K> coeffs for <K>P_1, P_3</K> are off!
...
This does not reduce to `True`, and suggests a missing interaction between <K>P_1</K> and <K>P_3</K>.
