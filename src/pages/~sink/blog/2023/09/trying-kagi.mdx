...
![Search results for Tom Cruise. Listed is wikipedia with a large list of summary points, and a bio box to the right.](/sink/quiet_kagi/1.png)
...
![A row of images of tom cruise, then a link to his imdb, and the sub-pages of him on imdb.](/sink/quiet_kagi/2.png)
...
![A kagi "quick answer" telling me that Tom Cruise is an American actor born in 1962, known for his roles in Top Gun, Mission: Impossible, and Jerry Maguire.
It tells me he rose to fame in the 80s and has received three Oscar nominations. It tells me he's a prominent Scientologist.
It cites 4 source links.](/sink/quiet_kagi/3.png)
...
![A calculator widget which has answered a few questions for me. "$20 in gbp" is "16.53 GBP",
"12 * 5" is 60, and "12lb in kg" is "5.44 kg" with 8 decimal places of precision.](/sink/quiet_kagi/4.png)
...
![The calculator widget correctly calculating sin values, doing math, and failing to sort an array of numbers, just listing "unknown"](/sink/quiet_kagi/5.png)

Translation works as well as you'd expect.

![A translation widget, converting "j'aime le chocolat" to "私はチョコレートが好きです。"](/sink/quiet_kagi/15.png)
![The same translation widget, converting "私はチョコレートが好きです。" to "I love chocolate."](/sink/quiet_kagi/16.png)
...
![Me starting a search with !w, and getting prompted to search wikipedia, wikizero, wiki2, w3c, wiki2 fr,
and then results for weather, wordle, wickes, wilko, and wolverhampton wanderers fc.](/sink/quiet_kagi/6.png)
...
![Search results for "riding a horse", which gave me results for how to ride a horse, equestrian centres on apple maps,
and the wikipedia entry for a riding horse.](/sink/quiet_kagi/17.png)

Also b r a i n s.

![A search for "brain", result listing articles about the anatomy and how it works, wikipedia, and a national geographic video,
with a wikipedia info box on the right also featuring academic database IDs](/sink/quiet_kagi/18.png)
